...
THIRD_PASS_TIMEOUT_SECONDS        = _float("THIRD_PASS_TIMEOUT_SECONDS", 195.0)
GLOBAL_DOC_TIMEOUT_SECONDS        = _float("GLOBAL_DOC_TIMEOUT_SECONDS", 150.0)
LARGE_FILE_THRESHOLD_BYTES        = _int("LARGE_FILE_THRESHOLD_BYTES", 1_000_000)
FASTLANE_MICRO_PROBE_ENABLED      = _bool("FASTLANE_MICRO_PROBE_ENABLED", True)
FASTLANE_IMAGE_ONLY_BUDGET_SECONDS = _float("FASTLANE_IMAGE_ONLY_BUDGET_SECONDS", 16.0)
FASTLANE_IMAGE_ONLY_HARD_DOC_BUDGET_SECONDS = _float("FASTLANE_IMAGE_ONLY_HARD_DOC_BUDGET_SECONDS", 16.0)
...
TEXT_SIMILARITY_THRESHOLD    = _int("TEXT_SIMILARITY_THRESHOLD", 60)
TEXT_STRONG_THRESHOLD        = _int("TEXT_STRONG_THRESHOLD", 85)
...
EDM_WORKER_THREADS           = _int("EDM_WORKER_THREADS", 3)
EDM_FILE_SETTLE_SECONDS      = _int("EDM_FILE_SETTLE_SECONDS", 1)
...
AWB_CONTEXT_KEYWORDS = (
    ...
    # OCR variants and additional FedEx/logistics labels
    "TRACKING#", "TRACK NO", "TRACK NUMBER", "TRACK #", "TRACK#",
    "WAYBILL NO", "WAYBILL NUMBER", "WAYBILL#", "WB NO", "WB NUMBER",
    "EXPRESS WAYBILL", "HOUSE WAYBILL", "MASTER WAYBILL",
    "HOUSE AIRWAYBILL", "MASTER AIRWAYBILL",
    "MANIFEST NO", "MANIFEST NUMBER", "MANIFEST#",
    "PRO NO", "PRO NUMBER", "PRO#",
    "SHIPMENT NO", "SHIPMENT NUMBER", "SHIPMENT TRACKING",
    "PARCEL NO", "PARCEL NUMBER", "PARCEL TRACKING",
    "OUTBOUND", "INBOUND",
    "COURIER NO", "COURIER NUMBER",
    "DISPATCH NO", "DISPATCH NUMBER",
